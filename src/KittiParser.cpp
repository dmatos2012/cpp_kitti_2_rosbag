...
KittiParser::KittiParser(const fs::path rootPath, const fs::path veloPointsDir)
: m_rootPath {rootPath}, m_veloPointsDir{veloPointsDir}
{
}



std::vector <std::string> KittiParser::extractVeloFiles(std::string rootPath)
{
...
std::vector <std::string> KittiParser::extractTimestamps(std::string rootPath)
{
...
int64_t KittiParser::stampToTime(std::string timestamp)
{
